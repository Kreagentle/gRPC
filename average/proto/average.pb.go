...
type AvgResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Number2       float64                `protobuf:"fixed64,1,opt,name=number2,proto3" json:"number2,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AvgResponse) GetNumber2() float64 {
	if x != nil {
		return x.Number2
	}
	return 0
...
var file_average_proto_rawDesc = []byte{
	...
	0x72, 0x22, 0x27, 0x0a, 0x0b, 0x41, 0x76, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x18, 0x0a, 0x07, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x32, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x01, 0x52, 0x07, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x32, 0x32, 0x4c, 0x0a, 0x0a, 0x43, 0x61,
	0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x3e, 0x0a, 0x09, 0x43, 0x61, 0x6c, 0x63,
	0x75, 0x6c, 0x61, 0x74, 0x65, 0x12, 0x16, 0x2e, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x28, 0x01, 0x42, 0x1c, 0x5a, 0x1a, 0x67, 0x69, 0x74, 0x68,
...
var file_average_proto_depIdxs = []int32{
	0, // 0: calculator.Calculator.Calculate:input_type -> calculator.AvgRequest
	1, // 1: calculator.Calculator.Calculate:output_type -> calculator.AvgResponse
