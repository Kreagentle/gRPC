...
type CalculatorClient interface {
	Calculate(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[AvgRequest, AvgResponse], error)
}
...
func (c *calculatorClient) Calculate(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[AvgRequest, AvgResponse], error) {
...
type Calculator_CalculateClient = grpc.ClientStreamingClient[AvgRequest, AvgResponse]

// CalculatorServer is the server API for Calculator service.
// All implementations must embed UnimplementedCalculatorServer
// for forward compatibility.
type CalculatorServer interface {
	Calculate(grpc.ClientStreamingServer[AvgRequest, AvgResponse]) error
...
func (UnimplementedCalculatorServer) Calculate(grpc.ClientStreamingServer[AvgRequest, AvgResponse]) error {
...
func _Calculator_Calculate_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CalculatorServer).Calculate(&grpc.GenericServerStream[AvgRequest, AvgResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Calculator_CalculateServer = grpc.ClientStreamingServer[AvgRequest, AvgResponse]
